...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260603145053_AddUserMfaAndLinkedChildren'
)
BEGIN
    ALTER TABLE [AppUsers] ADD [LinkedChildrenCsv] nvarchar(2000) NULL;
END;
...
BEGIN
    ALTER TABLE [AppUsers] ADD [MfaEnabled] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [AppUsers] ADD [TotpSecret] nvarchar(64) NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260603145053_AddUserMfaAndLinkedChildren', N'10.0.8');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260603152423_AddFoodItemDietaryMetadata'
)
BEGIN
    ALTER TABLE [CanteenFoodItems] ADD [Allergens] nvarchar(200) NULL;
END;
...
BEGIN
    ALTER TABLE [CanteenFoodItems] ADD [IsHalal] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [CanteenFoodItems] ADD [IsVegetarian] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [CanteenFoodItems] ADD [KCalories] int NULL;
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260603152423_AddFoodItemDietaryMetadata', N'10.0.8');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260603161701_AddPreOrderLoyaltyPricing'
)
BEGIN
    ALTER TABLE [CanteenOrders] ADD [IsPreOrder] bit NOT NULL DEFAULT CAST(0 AS bit);
END;
...
BEGIN
    ALTER TABLE [CanteenOrders] ADD [PickupAtUtc] datetime2 NULL;
END;
...
BEGIN
    ALTER TABLE [CanteenOrders] ADD [TableNumber] nvarchar(20) NULL;
END;
...
BEGIN
    CREATE TABLE [DiscountRules] (
        ...
        [EffectJson] nvarchar(max) NOT NULL,
        ...
        [UpdatedAtUtc] datetime2 NULL,
        [ClientId] int NULL,
        CONSTRAINT [PK_DiscountRules] PRIMARY KEY ([RuleId])
    );
END;
...
BEGIN
    CREATE TABLE [LoyaltyAccounts] (
        [LoyaltyAccountId] int NOT NULL IDENTITY,
        [UserExternalId] nvarchar(50) NOT NULL,
        [PointsBalance] decimal(12,2) NOT NULL,
        [CreatedAtUtc] datetime2 NOT NULL,
        [LastEarnedAtUtc] datetime2 NULL,
        [LastRedeemedAtUtc] datetime2 NULL,
        [ClientId] int NULL,
...
BEGIN
    CREATE TABLE [LoyaltyEntries] (
        [LoyaltyEntryId] bigint NOT NULL IDENTITY,
        ...
        [OccurredAtUtc] datetime2 NOT NULL,
        [ClientId] int NULL,
        CONSTRAINT [PK_LoyaltyEntries] PRIMARY KEY ([LoyaltyEntryId]),
        CONSTRAINT [FK_LoyaltyEntries_LoyaltyAccounts_LoyaltyAccountId] FOREIGN KEY ([LoyaltyAccountId]) REFERENCES [LoyaltyAccounts] ([LoyaltyAccountId]) ON DELETE CASCADE
    );
END;
...
BEGIN
    CREATE INDEX [IX_DiscountRules_ClientId] ON [DiscountRules] ([ClientId]);
END;
...
BEGIN
    CREATE INDEX [IX_DiscountRules_IsActive_Priority] ON [DiscountRules] ([IsActive], [Priority]);
END;
...
BEGIN
    CREATE INDEX [IX_DiscountRules_RuleCode] ON [DiscountRules] ([RuleCode]);
END;
...
BEGIN
    CREATE INDEX [IX_LoyaltyAccounts_ClientId] ON [LoyaltyAccounts] ([ClientId]);
END;
...
BEGIN
    CREATE INDEX [IX_LoyaltyAccounts_UserExternalId] ON [LoyaltyAccounts] ([UserExternalId]);
END;
...
BEGIN
    CREATE INDEX [IX_LoyaltyEntries_ClientId] ON [LoyaltyEntries] ([ClientId]);
END;
...
BEGIN
    CREATE INDEX [IX_LoyaltyEntries_LoyaltyAccountId] ON [LoyaltyEntries] ([LoyaltyAccountId]);
END;
...
BEGIN
    CREATE INDEX [IX_LoyaltyEntries_OrderId] ON [LoyaltyEntries] ([OrderId]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260603161701_AddPreOrderLoyaltyPricing', N'10.0.8');
END;
...
IF NOT EXISTS (
    SELECT * FROM [__EFMigrationsHistory]
    WHERE [MigrationId] = N'20260603164541_AddWebhookSubscriptions'
)
BEGIN
    CREATE TABLE [WebhookSubscriptions] (
        ...
        [EventsCsv] nvarchar(500) NOT NULL,
        [IsActive] bit NOT NULL,
        ...
        [CreatedBy] nvarchar(100) NULL,
        [ClientId] int NULL,
        CONSTRAINT [PK_WebhookSubscriptions] PRIMARY KEY ([SubscriptionId])
    );
END;
...
BEGIN
    CREATE TABLE [WebhookDeliveries] (
        ...
        [ResponseSnippet] nvarchar(2000) NULL,
        [FirstQueuedAtUtc] datetime2 NULL,
        [LastAttemptAtUtc] datetime2 NULL,
        [NextRetryAtUtc] datetime2 NULL,
        [CompletedAtUtc] datetime2 NULL,
        [ClientId] int NULL,
        CONSTRAINT [PK_WebhookDeliveries] PRIMARY KEY ([DeliveryId]),
        CONSTRAINT [FK_WebhookDeliveries_WebhookSubscriptions_SubscriptionId] FOREIGN KEY ([SubscriptionId]) REFERENCES [WebhookSubscriptions] ([SubscriptionId]) ON DELETE CASCADE
    );
END;
...
BEGIN
    CREATE INDEX [IX_WebhookDeliveries_ClientId] ON [WebhookDeliveries] ([ClientId]);
END;
...
BEGIN
    CREATE INDEX [IX_WebhookDeliveries_Status_NextRetryAtUtc] ON [WebhookDeliveries] ([Status], [NextRetryAtUtc]);
END;
...
BEGIN
    CREATE INDEX [IX_WebhookSubscriptions_ClientId] ON [WebhookSubscriptions] ([ClientId]);
END;
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20260603164541_AddWebhookSubscriptions', N'10.0.8');
END;
